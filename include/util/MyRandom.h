...
class RandomNumberGenerator {
 public:
  RandomNumberGenerator(int low, int high) : m_nd(low, high), m_ur(low, high), m_ui(low, high), mt_gen(r()) {}
  int GetRandomNumberByDefault() { return m_ur(e); }
  int GetRandomNumberByMt19937() { return m_ui(mt_gen); }
