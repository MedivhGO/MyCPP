...
#ifndef MYCPPIMPLEMENT_SKIPLIST_H
#define MYCPPIMPLEMENT_SKIPLIST_H
...
public:
    ...
    vector<KVPair < K, V>> get_all_in_range(
    const K &key1,
    const K &key2
    ){
...
#endif //MYCPPIMPLEMENT_SKIPLIST_H
