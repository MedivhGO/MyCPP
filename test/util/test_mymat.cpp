...
TEST(MyMatrixTest, multi) {
  MyMatrix<int> a{{1, 2, -3}, {1, 3, 0}, {2, -1, 1}};
  MyMatrix<int> b{{2, 1, 0}, {-2, -1, 1}, {2, 1, -3}};
  MyMatrix<int> c{{-8, -4, 11}, {-4, -2, 3}, {8, 4, -4}};
  EXPECT_EQ(c, a * b);
}

TEST(MyMatrixTest, multi_8) {
  MyMatrix<int> e{{9, 3, 5, 7, 5, 7, 13, 18},    {1, 9, 0, 4, 17, 2, 5, 8},    {4, 8, 6, 7, 5, 12, 3, 2},
                  {11, 2, 4, 11, 19, 13, 3, 4},  {17, 17, 16, 1, 1, 6, 3, 1},  {15, 11, 5, 20, 17, 3, 7, 16},
                  {10, 7, 2, 6, 18, 15, 17, 15}, {17, 4, 16, 19, 2, 15, 11, 0}};
  MyMatrix<int> f{{3, 9, 0, 1, 11, 12, 19, 11}, {5, 10, 8, 14, 12, 10, 14, 12}, {13, 11, 12, 4, 4, 13, 5, 7},
                  {8, 0, 18, 8, 0, 2, 8, 16},   {6, 0, 7, 18, 2, 5, 20, 6},     {17, 17, 0, 17, 5, 4, 9, 1},
                  {12, 8, 3, 9, 10, 3, 6, 3},   {15, 3, 18, 12, 7, 14, 17, 16}};
  MyMatrix<int> g{{738, 443, 608, 669, 456, 561, 841, 646},   {396, 197, 422, 640, 269, 330, 701, 430},
                  {486, 416, 342, 541, 278, 330, 534, 377},   {614, 420, 476, 781, 322, 438, 928, 549},
                  {511, 628, 380, 486, 524, 636, 758, 556},   {802, 455, 936, 961, 548, 737, 1305, 1034},
                  {931, 618, 635, 1076, 588, 639, 1198, 718}, {830, 712, 613, 679, 488, 593, 852, 711}};
